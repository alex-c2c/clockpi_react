...
import { fetchScheduleUpdate } from "../lib/api";
...
export default function ScheduleCard({
	...
	const handleToggleActive = async () => {
		...
		const result: Result<void> = await fetchScheduleUpdate(deviceId, data);
		if (!result.success) {
	...
	return (
		<div className="relative">
			<div className="cursor-pointer flex items-center gap-4 bg-stone-800 rounded-xl px-4 py-3 hover:bg-stone-700 transition">
				{/* Left section (info) */}
